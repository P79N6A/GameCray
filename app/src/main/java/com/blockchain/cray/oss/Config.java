...
//    public static final String OSS_CALLBACK_URL = "http://oss-demo.aliyuncs.com:23450";
    public static final String OSS_CALLBACK_URL = "http://47.111.129.248/oss/call/back";
    ...
    public static final String STS_SERVER_URL = "http://47.111.129.248/oss/auth/get";//STS 地址

    public static final String BUCKET_NAME = "crash-test";
    ...
    ///////////////////////////////Cray APP config   //////////////////////////////////
    public final static String bucketName = "crash-test";
    public final static String accessKeyId = "LTAIF3sIj64WyBgG";
    public final static String accessKeySecret = "6oOVfN5B04939Dl5h683lquPacujzs";
