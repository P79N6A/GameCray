...
public class AdoptedListFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View initView(LayoutInflater inflater) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_adopted, null);
    ...
    private void initDatas() {
        httpCommand.getCrayfishAdoptionList(2, "", new HttpCmdCallback() {
            @Override
            public void onSucceed(Response response) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        DebugLog.i("getCrayfishAdopted list,jsonString info: "+jsonString);
