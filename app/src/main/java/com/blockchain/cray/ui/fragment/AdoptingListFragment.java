...
public class AdoptingListFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View initView(LayoutInflater inflater) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_adopting, null);
    ...
    private void initDatas() {
        dataList.clear();
        httpCommand.getCrayfishAdoptionList(1, "", new HttpCmdCallback() {
            @Override
            public void onSucceed(Response response) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        DebugLog.i("getCrayfishAdoptionList,jsonString info: "+jsonString);
    ...
    private void initRecyclerView() {
        ...
        AnimationAdapter slideAdapter = new SlideInBottomAnimationAdapter(mAdoptionRecordAdapter);
        //设置不只第一次有动画
