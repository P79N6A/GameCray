 ...
 * 待转让
 */
public class TransferToFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View initView(LayoutInflater inflater) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_transfered_to, null);
    ...
    private void initDatas() {
        dataList.clear();
        httpCommand.getCrayfishTransList(Constans.CRAY_STATUS_TRANSFERTO,"",new HttpCmdCallback() {
            @Override
            public void onSucceed(Response response) {
                if (response.isSuccessful()) {
                    try {
                        String jsonString = response.body().string();
                        DebugLog.i("getCrayfishTransList to transfer,jsonString info: "+jsonString);
    ...
    private void initRecyclerView() {
        ...
        mTransferRecordAdapter = new TransferRecordAdapter(getActivity(),dataList,Constans.CRAY_STATUS_TRANSFERTO);
