...
public class TransferCompleteFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View initView(LayoutInflater inflater) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_transfering_complete, null);
    ...
    private void initRecyclerView() {
        ...
        mTransferRecordAdapter = new TransferRecordAdapter(getActivity(),dataList,Constans.CRAY_STATUS_TRANSFER_FINISH);
    ...
    private void initDatas() {
        httpCommand.getCrayfishTransList(Constans.CRAY_STATUS_TRANSFER_FINISH,"",new HttpCmdCallback() {
            @Override
            public void onSucceed(Response response) {
                if (response.isSuccessful()) {
                    try {
                        String jsonString = response.body().string();
                        DebugLog.i("getCrayfishTransList  transferComplete,jsonString info: "+jsonString);
