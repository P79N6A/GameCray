...
public class OssService {
    ...
    public void asyncPutImage(String object, String localFile, final OssUploadCallback ossUploadCallback) {
        final long upload_start = System.currentTimeMillis();
//        OSSLog.logDebug("upload start");
        DebugLog.d("upload start");

        if (object.equals("")) {
//            Log.w("AsyncPutImage", "ObjectNull");
            DebugLog.d("ObjectNull");
            return;
        }
...
//                Log.d("PutObject", "currentSize: " + currentSize + " totalSize: " + totalSize);
                DebugLog.i("currentSize: " + currentSize + " totalSize: " + totalSize);
                int progress = (int) (100 * currentSize / totalSize);
                mDisplayer.updateProgress(progress);
        ...
        OSSAsyncTask task = mOss.asyncPutObject(put, new OSSCompletedCallback<PutObjectRequest, PutObjectResult>() {
            ...
            public void onSuccess(PutObjectRequest request, PutObjectResult result) {
                ...
                DebugLog.i("===>> info: Bucket: " + mBucket
                        + "\nObject: " + request.getObjectKey()
                        + "\nETag: " + result.getETag()
                        + "\nRequestId: " + result.getRequestId()
                        + "\nCallback: " + result.getServerCallbackReturnBody());

                ossUploadCallback.onUploadResult(result.getServerCallbackReturnBody());
            }
